  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<BusinessesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final restaurantinfoBusinessesRecord = snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                  ...
                  FlutterFlowStaticMap(
                    location: restaurantinfoBusinessesRecord.location!,
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            restaurantinfoBusinessesRecord.name,
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          restaurantinfoBusinessesRecord.address,
                          style:
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Open until ${dateTimeFormat('jm', restaurantinfoBusinessesRecord.close)}',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Readex Pro',
                                    fontSize: 18.0,
                        ...
                        StreamBuilder<List<ReviewsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<ReviewsRecord> textReviewsRecordList =
                                snapshot.data!;
                            return Text(
                              '★${functions.getAverageRating(textReviewsRecordList.map((e) => e.rating).toList()).toString()} (${textReviewsRecordList.length.toString()} ratings)',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
