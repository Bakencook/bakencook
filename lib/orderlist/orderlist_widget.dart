                        ...
                        return Padding(
                          ...
                          child: StreamBuilder<MenuitemsRecord>(
                            stream: MenuitemsRecord.getDocument(
                                listViewOrdersRecord.items.first.menuItemRef!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                              ...
                              final menuItemMenuitemsRecord = snapshot.data!;
                              return Container(
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                '${listViewOrdersRecord.items.length.toString()} item(s)',
                                                style:
