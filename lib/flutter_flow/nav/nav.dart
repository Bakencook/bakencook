      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: RestaurantdetailWidget(
              businessRef: params.getParam('businessRef',
        ...
        FFRoute(
          ...
          path: '/menuitemsdetail',
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: MenuitemsdetailWidget(
              menuitemRef: params.getParam(
                  'menuitemRef',
                  ParamType.DocumentReference,
                  false,
                  ['Businesses', 'menuitems']),
            ),
          ),
        ),
        FFRoute(
