...
class _HomepageWidgetState extends State<HomepageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.businessFilter = widget.category;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<BusinessesRecord>>(
      stream: queryBusinessesRecord(
        queryBuilder: (businessesRecord) => businessesRecord.where('category',
            isEqualTo:
                _model.businessFilter != '' ? _model.businessFilter : null),
      ),
      builder: (context, snapshot) {
        ...
        List<BusinessesRecord> homepageBusinessesRecordList = snapshot.data!;
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onFieldSubmitted: (_) async {
                                      await queryBusinessesRecordOnce()
                                          .then(
                                            (records) => _model
                                                    .simpleSearchResults =
                                                TextSearch(
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final business = functions
                              .getBusinessList(
                                  homepageBusinessesRecordList.toList(),
